...
StartupEvents.registry('item', event => {
	...
	let G = (x) => `${(x||1) * 64}x thermal:silver_coin`
	...
	let simple = (name, item, coin, c1, c2) => {
		if (!simulate)
			trade(name, c1, c2, [{ in: S(coin), out: item }])
		if (!DATAGEN_QUESTS)
			return
	...
	while (true) {
		...
		simple("Deepslate", MC('deepslate', 16), 12, 0x140E0F, 0x2D2831)
		...
		simple("Cobbled Deepslate", MC('cobbled_deepslate', 8), 1, 0x4A4A4F, 0x737373)
		simple("Honeycomb Block", MC('honeycomb_block', 16), 2, 0xFCE17D, 0xE58A08)
		...
		simple("Cherry Log", MC('cherry_log', 16), 8, 0xd6b8ad, 0x3a222c)
		...
		simple("Nickel Ingot", TE('nickel_ingot', 8), 32, 0x977756, 0xE4D196)
		simple("Lead Ingot", TE('lead_ingot', 8), 32, 0x232456, 0x7C95A4)
		...
		simple("Invar Ingot", TE('invar_ingot', 4), 64, 0x406D6C, 0xC3CAC1)
		
		entry_cost = 10
		simple("Coal", MC('coal', 16), 4, 0x1C1C1E, 0x383D45)
		simple("Flint", MC('flint', 16), 4, 0x3C3B3B, 0xA6A6A6)
		simple("Cinnabar", TE('cinnabar', 4), 16, 0xFC7781, 0xFCCED0)
		...
		simple("Amethyst", MC('amethyst_shard', 8), 32, 0xBC96AA, 0x523A7E)
		simple("Sulfur", TE('sulfur', 4), 8, 0xC7A94A, 0xEEF071)
		simple("Apatite", TE('apatite', 4), 8, 0x27A9BB, 0x2CC7C9)
		simple("Niter", TE('niter', 4), 8, 0x735A65, 0xB8AFAF)
		...
		simple("Fluix Quartz", AE2('fluix_crystal', 8), 32, 0x8F5CCB, 0xFC7ED4)
		simple("Cured Rubber", TE('cured_rubber', 6), 16, 0x3D363C, 0x594F55)
		simple("Bitumen", TE('bitumen', 1), 8, 0x0B0909, 0x0B0909)
		...
		simple("Glow Berries", MC('glow_berries', 8), 11, 0xB7A74F, 0x909223)
		simple("Vines", MC('vine', 4), 7, 0x183D08, 0x317B10)
		simple("Glow Lichen", MC('glow_lichen', 4), 4, 0x515D58, 0x729083)
		simple("Moss Block", MC('moss_block', 1), 8, 0x4D5B23, 0x6F902C)
		simple("Glowing Moss Block", BOP('glowing_moss_block', 1), 12, 0x144B6A, 0x153044)
		simple("Tree Fertilizer", CR('tree_fertilizer', 1), 6, 0xCF8469, 0x71933A)
		simple("Sculk", MC('sculk', 1), 6, 0x073b60, 0xb2d39)
		simple("Pink Petals", MC('pink_petals', 8), 3, 0xFF69B4, 0xFFC0CB)
		simple("Big Dripleaf", MC('big_dripleaf', 4), 3, 0x228B22, 0x32CD32)
		...
		simple("Iron Sheet Metal", CD('iron_sheet_metal', 16), 3, 0xE3E3E3, 0x717171)
		simple("Brass Sheet Metal", CD('brass_sheet_metal', 16), 3, 0xfbe88a, 0x8f6f3f)
		simple("Industrial Iron Sheet Metal", CD('industrial_iron_sheet_metal', 16), 3, 0x68666e, 0x3a383c)
		...
		simple("Soul Lantern", MC('soul_lantern', 1), 1, 0x1c8c94, 0x333343)
		...
		simple("Glow Ink Sac", MC('glow_ink_sac', 2), 8, 0x29807E, 0x5AB488)
		...
		simple("Phantom Membrane", MC('phantom_membrane', 1), 24, 0x6E506B, 0xC1B79F)
