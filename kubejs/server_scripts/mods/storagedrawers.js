...
if(Platform.isLoaded("functionalstorage")) {
	ServerEvents.recipes(event => {
		...
		zincMachine(event, Item.of('functionalstorage:simple_compacting_drawer', 1), MC('piston'))
		zincMachine(event, Item.of('functionalstorage:compacting_drawer', 1), MC('sticky_piston'))
